...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    float time_spent = (stop_time - start_time) / 125.0e6; // Assuming clock frequency is 125 MHz
    
    // Calculate throughput in Megabytes/second
    float throughput = (bytes_transferred / (1024.0 * 1024.0)) / time_spent;
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Thomas Coverstone - Custom Peripheral Demonstration\n\r");
